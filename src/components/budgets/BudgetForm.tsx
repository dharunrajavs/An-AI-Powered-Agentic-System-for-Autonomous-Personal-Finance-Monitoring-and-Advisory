    ...
    <>
      ...
      >
        <BottomSheetView style={{ paddingHorizontal: 20, paddingBottom: 36, paddingTop: 4, gap: 20 }}>
          <Text className="text-white font-heading-semibold text-lg">
            {editingBudget ? 'Edit Budget' : 'Add Budget'}
          </Text>

          <View className="gap-2">
            <Text className="text-muted font-body-medium text-xs uppercase tracking-wide">Category</Text>
            <Controller
              control={control}
              name="category"
          ...
          <View className="gap-2">
            <Text className="text-muted font-body-medium text-xs uppercase tracking-wide">Limit</Text>
            <Controller
              control={control}
              name="limit"
          ...
          <View className="gap-2">
            <Text className="text-muted font-body-medium text-xs uppercase tracking-wide">Period</Text>
            <Controller
              control={control}
              name="period"
              render={({ field: { onChange, value } }) => (
                <View className="flex-row bg-background border border-border rounded-xl p-1 gap-1">
                  {(['monthly', 'weekly'] as const).map((period) => {
                    ...
                    return (
                      ...
                      >
                        <Text className={`font-body-semibold text-sm ${selected ? 'text-background' : 'text-muted'}`}>
