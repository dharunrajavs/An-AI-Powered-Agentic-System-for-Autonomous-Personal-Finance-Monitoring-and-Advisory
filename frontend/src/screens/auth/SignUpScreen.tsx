...
const GoogleIcon = () => (
  <View style={{ width: 20, height: 20 }} aria-hidden={true as const}>
    ...
    <View className="w-full max-w-[440px]">
      ...
      <View className="gap-5">
        ...
        <View className="flex-row items-center gap-3 my-4">
          ...
          <Text className="text-on-surface-variant font-body text-xs">or continue with</Text>
          <View className="flex-1 border-t border-outline-variant" />
        </View>
        ...
        <Pressable
          ...
          className="w-full flex-row items-center justify-center gap-2 border border-outline-variant/50 bg-surface-container-low py-3 rounded-full active:opacity-80"
        >
          <GoogleIcon />
          <Text className="text-on-surface font-body-semibold text-base">Continue with Google</Text>
        </Pressable>
